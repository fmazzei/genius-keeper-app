...
- **3.10 — Cierre formal + cableo de Anaquel + retiro legacy + limpieza** ✅ (track comisiones cerrado):
  ...
  - **Pendiente futuro (opcional)**: rol "administrador" con módulos asignables (Liquidaciones/Conciliación/Cierre); blindar atribución con `customer_id` real; proyección de comisión "al ritmo actual" en el Home.
