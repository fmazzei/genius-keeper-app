...
import { ClipboardList, ChevronLeft, CheckCircle, RefreshCw } from 'lucide-react';
    ...
    if (sent) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-4 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-slate-800">¡Pedido Enviado!</h3>
                ...
                <button
                    onClick={() => { setSent(false); setPosId(''); setCantidad(''); }}
        ...
        <div className="p-4 md:p-8 max-w-lg mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <p className="text-xs text-center text-slate-400">
                    El pedido se enviará automáticamente a ventas@lacteoca.com
                </p>
            </form>
