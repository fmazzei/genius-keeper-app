...
const AppShell = ({ user, role, onLogout }) => {
    ...
    const merchandiserContent = () => {
        switch(currentView) {
            case 'hub': return <MerchandiserHub onNavigate={setCurrentView} selectedReporter={selectedReporter} posList={masterStopList} />;
            ...
            default: return <MerchandiserHub onNavigate={setCurrentView} selectedReporter={selectedReporter} posList={masterStopList} />;
        }
    };
