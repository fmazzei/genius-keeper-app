...
export const DEFAULT_MODULES = {
    ...
    kroma_admin:     { produccionDiaria: false, leche: false, inventarioMateriales: true,  constructores: false, despachos: true,  almacenes: true,  historialProduccion: true,  catalogos: true,  usuarios: true,  controlSistema: true,  dashboardsGerenciales: false },
