...
export const SuppliersPage = () => (
    <ComingSoon
        ...
        description="Base de datos completa de todos los proveedores de la planta."
        items={[
            { title: 'Perfil legal y comercial', desc: 'Nombre, RIF, dirección fiscal, contacto, teléfono, correo.' },
            { title: 'Tipificación', desc: 'Materia prima (leche), empaques, insumos, detergentes, reactivos, laboratorios.' },
            { title: 'Datos bancarios nacionales', desc: 'Banco, cuenta, nombre, RIF/Cédula, Pago Móvil.' },
            { title: 'Datos bancarios internacionales', desc: 'Zelle y campo multilínea para cuentas extranjeras.' },
        ]}
    />
);

export const MaterialsMasterPage = () => (
    <ComingSoon
        title="Maestro de Materiales y Costos"
        description="Base de datos central de insumos, empaques y consumibles con costeo en dólares."
        items={[
            { title: 'Ficha de suministro', desc: 'Vinculado a proveedor, presentación de entrada (sobre, saco, bulto, unidad).' },
            { title: 'Unidades de medida', desc: 'Litro, ml, Kg, g — seleccionables o creables.' },
            { title: 'Motor de valoración USD', desc: 'Costo macro → precio por g/Kg/ml/litro automático.' },
            { title: 'Costo Promedio Ponderado', desc: 'Recalculo de valor ante variaciones de precio en compras.' },
        ]}
    />
);
