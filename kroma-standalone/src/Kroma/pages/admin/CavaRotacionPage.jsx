    ...
    return (
        <div className="space-y-5">
            ...
            <div>
                ...
                <p className="text-slate-600 text-[10px] mt-1">Los depósitos comerciales muestran datos del Depósito de Destino.</p>
            </div>
...
export default function CavaRotacionPage() {
    ...
    // - Para almacenes comerciales: kroma_inventario_destino (fuente de verdad: depósito de destino)
